...
def generate_html_report(cambio, titulo_cambio, tower_user_name, output_file, dest_infoprepos):
    files = glob.glob(f'{dest_infoprepos}/{cambio}/reporte_final/filesystems_*')
...
def get_host_header_data(host, cambio, dest_infoprepos):
    header_file = f'{dest_infoprepos}/{cambio}/reporte_final/header_{host}'
...
def generate_host_section(host, cambio, host_data, dest_infoprepos):
    ...
    for file_type in file_types:
        file_path = f'{dest_infoprepos}/{cambio}/reporte_final/{file_type}_{host}'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output', default='reporte_final.html', help='Archivo de salida HTML')
